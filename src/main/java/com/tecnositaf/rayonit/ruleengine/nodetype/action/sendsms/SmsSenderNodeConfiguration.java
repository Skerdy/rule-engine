package com.tecnositaf.rayonit.ruleengine.nodetype.action.sendsms;
...
import com.tecnositaf.rayonit.ruleengine.nodetype.action.sendmail.InsufficientMailArgumentsException;
