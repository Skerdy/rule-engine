package com.skerdy.ruleengine.api.node.service;

import com.google.gson.Gson;
import com.skerdy.ruleengine.api.node.model.ComponentDescriptor;
import com.skerdy.ruleengine.api.node.model.FieldDescriptor;
import com.skerdy.ruleengine.api.node.repository.ComponentDescriptorRepository;
...
import com.skerdy.ruleengine.core.node.NodeDefinition;
...
public class RuleNodeService implements ComponentDescriptorService {
    ...
    private final String nodesPackage = "com.skerdy.ruleengine.nodetype";
    ...
    private List<FieldDescriptor> collectConfigurattionFieldsForFields(Field[] fields){
        ...
        for(Field field: fields ){
            ...
            if(configAnottation!=null){
                ...
                if(field.getType().getName().contains("com.skerdy.ruleengine.nodetype")){
